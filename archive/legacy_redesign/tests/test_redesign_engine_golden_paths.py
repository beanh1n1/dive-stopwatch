...
from .golden_paths import GoldenExpectation, GoldenFixture, RedesignEngineAdapter, load_golden_fixtures
...
class RedesignEngineGoldenPathTests(unittest.TestCase):
    def test_supported_golden_paths(self) -> None:
    ...
    def _run_fixture(self, fixture: GoldenFixture) -> None:
        adapter = RedesignEngineAdapter(fixture)
    ...
    def _assert_expectation(self, fixture_id: str, step_index: int, adapter: RedesignEngineAdapter, expect: GoldenExpectation) -> None:
