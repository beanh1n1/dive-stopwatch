...
class MobileDiveStopwatchApp:
    ...
    def mount(self) -> None:
        ...
        self.page.fonts = {
            self.INSTRUMENT_FONT: str(Path(__file__).resolve().parents[4] / "assets" / "fonts" / "CaissonCockpit.ttf"),
            self.BRAND_FONT: str(Path(__file__).resolve().parents[4] / "assets" / "fonts" / "vintage_hand_type.otf"),
        }
