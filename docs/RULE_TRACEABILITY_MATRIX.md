...
| `9-11.4` | Delay leaving a stop or between stops | Chapter 9, pp.32-35 | Partially Implemented | [RULE_delay_corrections.md](/Users/iananderson/projects/DiveStopwatchProject/docs/RULE_delay_corrections.md), [SCENARIO_delay_boundaries.md](/Users/iananderson/projects/DiveStopwatchProject/docs/SCENARIO_delay_boundaries.md) | `tests/test_minimal_engine.py` between-stop delay tests | `src/dive_stopwatch/minimal/profiles.py`, `src/dive_stopwatch/minimal/engine.py` | Deep recompute, exact-60s ignore, and shallow later-stop auditability are covered; oxygen-delay subtraction/interruption behavior is still not separately modeled |
