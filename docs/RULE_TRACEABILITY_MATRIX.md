...
| `9-11.4` | Delay leaving a stop or between stops | Chapter 9, pp.32-35 | Implemented for current in-water runtime | [RULE_delay_corrections.md](/Users/iananderson/projects/DiveStopwatchProject/docs/RULE_delay_corrections.md), [SCENARIO_delay_boundaries.md](/Users/iananderson/projects/DiveStopwatchProject/docs/SCENARIO_delay_boundaries.md) | `tests/test_minimal_engine.py` and `tests/test_minimal_profiles.py` delay tests | `src/dive_stopwatch/minimal/profiles.py`, `src/dive_stopwatch/minimal/engine.py` | Deep recompute, exact-60s ignore, shallow later-stop auditability, explicit `30 -> 20` O2 delay credit, and explicit `20 fsw` departure-delay handling are covered |
